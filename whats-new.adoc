...
* *Supporto per VM proxy durante il ripristino di file e cartelle* - Ora è possibile ripristinare file e cartelle su altre VM ospitate sulla sorgente vCenter. Per ulteriori informazioni, consultare  https://docs.netapp.com/us-en/data-services-backup-recovery/br-use-vmware-restore.html["Ripristina i carichi di lavoro VMware"].
* *Ricerca ricorsiva di file e cartelle* - Ora è possibile cercare un file o una cartella specifici all'interno di un intero file VMDK. Per ulteriori informazioni, consultare  https://docs.netapp.com/us-en/data-services-backup-recovery/br-use-vmware-restore.html["Ripristina i carichi di lavoro VMware"].
* *Gestione dei job migliorata*: NetApp Backup and Recovery ora gestisce più job simultanei in modo più efficiente.
...
Direttiva non risolta in _whatsnew/2026-04-13_data-services-cloud-tiering.adoc - include::../_include/cloud-tiering-eol.adoc[]
...
Per ulteriori informazioni sul supporto per GCVE, consultare link:https://docs.netapp.com/us-en/data-services-disaster-recovery/release-notes/dr-limitations.html["configurazioni supportate per NetApp Disaster Recovery"^].
...
Ransomware Resilience ora offre il supporto per la gestione degli eventi e delle informazioni di sicurezza (SIEM) per Splunk Enterprise, consentendo di centralizzare i dati di log e degli eventi e semplificare l'analisi e il rilevamento delle minacce.

Per ulteriori informazioni, vedere link:https://docs.netapp.com/us-en/data-services-ransomware-resilience/task-siem.html["Collega la resilienza al ransomware a un SIEM"^].



==== Miglioramento dell'attività del comportamento utente

Le informazioni relative alle violazioni dei dati vengono ora conservate per 13 mesi dopo l'incidente, consentendo una documentazione più completa per le vostre esigenze di reporting.
