...
Per maggiori informazioni, vedere link:https://docs.netapp.com/us-en/data-services-disaster-recovery/use/drplan-create.adoc["Creare un piano di replicazione"].
...
Per maggiori informazioni, vedere link:https://docs.netapp.com/us-en/data-services-disaster-recovery/reference/switch-console-agents.html["Agenti della console Switch"].
...
NetApp ha rinominato Canvas nella pagina *Sistemi*. Accedere alla pagina *Sistemi* dal menu *Archiviazione > Gestione*.
